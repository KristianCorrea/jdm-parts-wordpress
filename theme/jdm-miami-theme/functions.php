...
function jdm_miami_setup() {
	/*
		...
		* If you're building a theme based on JDM Miami, use a find and replace
		* to change 'jdm_miami' to the name of your theme in all the template files.
		*/
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'jdm_miami_custom_background_args',
			array(
...
function jdm_miami_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'jdm_miami_content_width', 640 );
}
...
function jdm_miami_scripts() {
	...
	wp_enqueue_script( 'jdm_miami-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );

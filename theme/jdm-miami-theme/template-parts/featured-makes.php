<?php
/**
 * Featured makes (vehicle make tile grid).
 *
 * @package JDM_Miami
 */
...
<section class="jdm-section">
	<div class="jdm-container">
		<div class="jdm-section-header">
			<div>
				<span class="jdm-eyebrow"><?php esc_html_e( 'Browse by make', 'jdm_miami' ); ?></span>
				<h2 class="jdm-heading-lg" style="margin-top: 0.75rem;">
					<?php esc_html_e( 'Featured Makes', 'jdm_miami' ); ?>
				</h2>
			</div>
					...
					<p class="jdm-tile-sub">
						...
						echo esc_html(
							$term->description
								...
								: __( 'Shop inventory for this make.', 'jdm_miami' )
						);
						?>
					</p>
				</a>
